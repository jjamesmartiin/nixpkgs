...
let
  ...
  cudaToolkit = buildEnv {
    ...
    # - https://github.com/ollama/ollama/blob/v0.20.0/CMakePresets.json#L21-L47
...
goBuild (finalAttrs: {
  ...
  # https://github.com/ollama/ollama/blob/v0.20.0/docs/development.md#library-detection
  postInstall = ''
    mkdir -p $out/lib
